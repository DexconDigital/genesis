            ...
            <div class="banner_estadi ">
                <div class="container  contenedor_banner">
                    ...
                    <div class="row d-flex justify-content-between" style="padding: 73px;">
                        <div class="espacio_div col-xl-2 col-md-4 col-12 text-center color_estadis" style="">
                            <div>
                        ...
                        <div class=" espacio_div col-xl-2 col-md-6 col-12 text-center color_estadis" style="">
                            <div>
